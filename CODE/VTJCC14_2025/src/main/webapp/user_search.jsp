...
<title>User Search | Cloud Security Portal</title>
...
<div class="search-wrapper glass">
    ...
    <form action="UserSearchServlet" method="post">
        <input type="text" name="custom_filename" placeholder="Enter Custom Filename" required>
...
<div class="footer glass">
    © 2025 Cloud Security Framework | Secure User Search
</div>
