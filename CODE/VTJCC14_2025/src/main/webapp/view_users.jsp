...
<head>
<meta charset="UTF-8">
<title>Registered Users | Cloud Security Portal</title>
...
<body>
	...
	<div class="header-bar glass">
		<h1>Cloud Security Administration & User Management</h1>
	</div>
	...
	<div class="table-wrapper glass">
		<h2 style="text-align: center; margin-bottom: 25px;">Registered
			Users</h2>
        ...
        %>
			<tr>
				...
				<td
					class="<%= "APPROVED".equals(status) ? "status-approved" : "status-pending" %>">
					<%= status %>
				</td>
