...
<title>Admin Approvals | Cloud Security Portal</title>
...
<div class="header-bar glass">
    <h1>Cloud Security Administration & User Approvals</h1>
</div>
...
<div class="table-wrapper glass">
    <h2 style="text-align:center; margin-bottom:25px;">Pending User Approvals</h2>
