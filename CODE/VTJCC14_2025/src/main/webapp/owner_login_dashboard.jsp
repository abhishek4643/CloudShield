...
<title>Owner Dashboard | Cloud Security Portal</title>
...
<div class="page-content">
    <div class="options-container">
        ...
        <div class="container-box" onclick="location.href='upload.jsp'">
            Upload
        </div>

        <div class="container-box" onclick="location.href='owner_requests.jsp'">
            Requests
        </div>
