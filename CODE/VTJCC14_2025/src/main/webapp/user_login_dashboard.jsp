...
<title>User Dashboard | Cloud Security Portal</title>
...
<div class="header-bar glass">
    <h1>User Secure Data Access Dashboard</h1>
</div>
...
<div class="page-content">
    <div class="options-container">
        ...
        <div class="container-box" onclick="location.href='user_search.jsp'">
            Search
        </div>

        <div class="container-box" onclick="location.href='approvedsearch.jsp'">
            Approved Search
        </div>
...
<div class="footer glass">
    © 2025 Cloud Security Framework | User Control Panel
</div>
